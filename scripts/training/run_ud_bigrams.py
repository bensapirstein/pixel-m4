...
# from pixel.data.rendering.pangocairo_renderer_bigrams_udp import PangoCairoTextRenderer as PangoCairoBigramsRenderer
...
def log_predictions(
    ...
    report_to_wandb = "wandb" in args.report_to
    # Initialize wandb if not already done
    if not args.do_train and report_to_wandb:
...
def get_dataset(
    ...
    processor: Union[Union[PyGameTextRenderer, PangoCairoBigramsRenderer], PreTrainedTokenizerFast],
    modality: Modality,
    split: Split,
